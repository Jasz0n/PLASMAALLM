"""M39 stable curriculum capstone — KS + maintenance + capability progression.

    PYTHONPATH=src python3 examples/67_stable_curriculum_phased_kel.py
    PYTHONPATH=src ALLM_STUDENT_SIZE=large python3 examples/67_stable_curriculum_phased_kel.py
"""
...
def main() -> None:
    setup_logging("INFO")
    _apply_defaults()
    parser = argparse.ArgumentParser(description="M39 stable curriculum phased KEL")
