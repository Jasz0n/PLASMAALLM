"""M40 KS-driven planner capstone — forgetting risk in need scoring.

    PYTHONPATH=src python3 examples/68_ks_planner_phased_kel.py
    PYTHONPATH=src ALLM_STUDENT_SIZE=large python3 examples/68_ks_planner_phased_kel.py
"""
...
def main() -> None:
    setup_logging("INFO")
    _apply_defaults()
    parser = argparse.ArgumentParser(description="M40 KS-driven planner phased KEL")
