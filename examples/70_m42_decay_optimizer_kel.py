"""M42 capstone — decay prediction + maintenance optimizer + richer KS.

    PYTHONPATH=src python3 examples/70_m42_decay_optimizer_kel.py
    PYTHONPATH=src ALLM_STUDENT_SIZE=large python3 examples/70_m42_decay_optimizer_kel.py
"""
...
def main() -> None:
    setup_logging("INFO")
    _apply_defaults()
    parser = argparse.ArgumentParser(description="M42 decay optimizer capstone")
